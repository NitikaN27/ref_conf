		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Overall Refinery Configuration",
									"targetURL": "#comrefconfrefconf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrefconfrefconf-display": {
								"semanticObject": "comrefconfrefconf",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ref.conf.refconf",
									"url": sap.ui.require.toUrl("com/ref/conf/refconf")
								}
							}
						}
					}
